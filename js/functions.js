...
function changeProfile(){
				var string = '<form class="forms" action="changeProfile.php" method="post">'
...
function uploadJob(){
		var string ='<form class="forms" action="addJob.php" method="post">'
	+		'Description:<input type="text" name="desc" style="width:400px;height:45px;"></br>'
	+		'Contact Info:<input type="text" name="contact" style="width:400px;height:45px"></br>'
	+		'Skills needed:<input type="text" name="skills" style="width:400px;height:45px;"></br>'
	+		'<input type="submit" value="Login" style="width:800px;height:45"/>'
	+	'</form>';		
	//alert(string);
	document.getElementById("alter").innerHTML= string;
